<x-Front-Layout title="Check Out">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="email" name="addr[billing][email]"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <input type="number" name="addr[billing][phone_number]"
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="col-md-6 form-input form">
                                                        <input type="text" name="addr[billing][street]"
                                                            placeholder="street">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Email Address</label>
                                                    <div class="form-input form">
                                                        <input type="email" name="addr[shipping][email]"
                                                            placeholder="Email Address">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Phone Number</label>
                                                    <div class="form-input form">
                                                        <input type="number" name="addr[shipping][phone_number]"
                                                            placeholder="Phone Number">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    <label>Mailing Address</label>
                                                    <div class="col-md-6 form-input form">
                                                        <input type="text" name="addr[shipping][street]"
                                                            placeholder="street">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form button">
                                                    <button class="btn" data-bs-toggle="collapse"
                                                        data-bs-target="#collapseFour" aria-expanded="false"
                                                        aria-controls="collapseFour"> Next </button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                ...
                <div class="col-lg-4">
                    <div class="checkout-sidebar">
                        ...
                        <div class="checkout-sidebar-price-table mt-30">
                            <h5 class="title">Your Items</h5>

                            <div class="sub-total-price">
                                @foreach ($cart->getCart() as $items)
                                    <div class="total-price">
                                        <p class="value">{{ $items->product->name }}</p>
                                        <p class="price">{{ Currency::format($items->product->price) }}</p>
                                    </div>
                                @endforeach
                            </div>
                            ...
                            <div class="price-table-btn button">
                                <a href="{{ route('checkout.store') }}" class="btn btn-alt">Checkout</a>
                            </div>
                        </div>
